(() => {
  ...
  // src/lib/jobRename.js
  init_define_import_meta_env();

  // src/lib/jobNames.js
  init_define_import_meta_env();
  function renamePatch(job, nextName) {
  ...
  function planMatchesJob(plan, job) {
  ...
  // src/lib/jobRename.js
  async function renameJob(job, nextName) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(LedgerContext.Provider, { value: ledger, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: ledger ? "relative pl-6" : "space-y-5", children: [
        ...
        days.map(({ date, items }, di) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: ledger ? `relative ${di ? "mt-5 border-t pt-5" : ""}` : "", style: ledger ? { borderColor: "#eee9e0" } : void 0, children: [
          ledger ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { "aria-hidden": "true", className: `absolute -left-6 h-[13px] w-[13px] rounded-full ${di ? "top-[29px]" : "top-[8px]"}`, style: { backgroundColor: "#b8955a", border: "2px solid #fff", boxShadow: "0 0 0 1px #b8955a" } }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: ledger ? "mb-2" : "mb-2 flex items-center gap-3", children: [
            ledger ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "inline-flex items-center rounded-[8px] px-2.5 py-1 text-[15px] font-extrabold tracking-[-0.01em] whitespace-nowrap", style: { backgroundColor: "#f6efe0", color: "#5c3f0e", border: "1px solid #e8d9b5" }, children: formatDateGroup(date) }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "text-[13px] font-bold whitespace-nowrap", style: { color: C.text }, children: formatDateGroup(date) }),
  ...
  function JobTitle({ job, onRename, headingLevel }) {
    ...
    const save = async () => {
      ...
      if (!next || next === job.canonical_name) {
        setEditing(false);
        return;
      }
      setSaving(true);
    ...
    if (editing && onRename) {
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "mt-1.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-wrap items-center gap-2", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", onClick: save, disabled: saving, className: "inline-flex h-[38px] items-center rounded-[9px] px-3.5 text-[13.5px] font-semibold disabled:opacity-60", style: { backgroundColor: "#cfe3da", color: "#082f2c" }, children: saving ? "Saving\u2026" : "Save" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", onClick: () => setEditing(false), className: "inline-flex h-[38px] items-center rounded-[9px] px-3 text-[13.5px] font-semibold", style: HERO_SEC, children: "Cancel" })
        ] }),
        error ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { role: "alert", className: "m-0 mt-1 text-[12px]", style: { color: "#f1b9b3" }, children: error }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "m-0 mt-1 text-[12px]", style: { color: "#8f999b" }, children: "The old name is kept so past visits and files still match this job." })
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "group mt-1.5 flex items-start gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(H, { className: "m-0 break-words text-[32px] font-bold leading-[38px] max-[699px]:text-[26px] max-[699px]:leading-[31px]", style: { color: HERO_INK, letterSpacing: "-0.035em" }, children: shown }),
      onRename ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", onClick: start, "aria-label": "Rename job", title: "Rename job", className: "mt-2 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-[7px] opacity-60 hover:opacity-100 max-[699px]:mt-1", style: { color: BRASS_LT, backgroundColor: "rgba(255,255,255,.06)" }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Pencil, { className: "h-3.5 w-3.5" }) }) : null
    ] });
  }
  ...
  function JobHero({ job, status, snap, jobContacts, events, folder, plans, onFieldReport, onLog, onRename, extra, headingLevel = "h1" }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("section", { className: "relative z-[3] rounded-[14px]", style: { background: "linear-gradient(160deg,#10292b 0%,#0a1d1f 100%)", boxShadow: "0 20px 44px -26px rgba(10,29,31,.7)" }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "px-7 pt-7 pb-4 max-[699px]:px-4 max-[699px]:pt-5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-wrap items-stretch gap-6 max-[699px]:gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "min-w-[240px] flex-1", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(JobTitle, { job, onRename, headingLevel }),
  ...
  var MUTED3 = "#566063";
  var TEAL = "#0b3f3b";
  function JobWorkspacePanel({ jobId, group = null, onJobChanged }) {
    ...
    const load = async ({ quiet = false } = {}) => {
      ...
      try {
        ...
        base44.entities.PlanIntake.list("-created_date", 200).then((all2) => {
          if (ver !== v.current) return;
          setPlans(all2.filter((p) => planMatchesJob(p, jb)));
        }).catch(() => {
        });
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "px-6 pt-6 pb-10 flex flex-col gap-[18px] max-[1400px]:px-5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
          JobHero,
          {
            ...
            onRename: async (name) => {
              const next = await renameJob(job, name);
              setJob(next);
              onJobChanged?.(next);
            },
            headingLevel: "h2",
