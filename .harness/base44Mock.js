...
const REPORTS = [{ id: 'fr1', post_id: 'p1', job_id: 'j1', job_name: 'Rainey warranty', job_date: '2026-09-25', author: 'ragen@x.com', photo_urls: [PH('%23c9b58a'), PH('%23b9a17a'), PH('%23d6c39a'), PH('%23a8946c'), PH('%23c2ad84')], message: 'Changed the balance springs, checked ops on all windows. 1 man hour' }];
