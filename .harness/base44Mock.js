...
const rows = { Jobs: [JOB, J(2, 'Bangerter Homes - Gomez Res', 'BANGERTER HOMES', '11772 S Meyers Pl'), J(3, 'Hidden Hollow - Bldg I Unit 329', 'Cadence Homes', ''), J(4, 'Rainey 9-138 Daybreak', '', '6741 W Splash Way South Jordan')], CalendarEvents: EVENTS };
window.__rows = rows;
const entity = (name) => ({
  get: async () => JOB,
