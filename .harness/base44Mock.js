...
const J = (id, n, b, a) => ({ id: String(id), canonical_name: n, builder: b, address: a, aliases: [], po_numbers: [], oe_numbers: [], created_date: '2026-09-2' + (id % 9) });
const rows = { Jobs: [JOB, J(2, 'Bangerter Homes - Gomez Res', 'BANGERTER HOMES', '11772 S Meyers Pl'), J(3, 'Hidden Hollow - Bldg I Unit 329', 'Cadence Homes', ''), J(4, 'Rainey 9-138 Daybreak', '', '6741 W Splash Way South Jordan'), J(5, 'Titan Construction - Howe', 'TITAN CONSTRUCTION', '7813 Susans Cir'), J(6, 'Durkin 62 Wildwood', '', '')], CalendarEvents: EVENTS };
window.__rows = rows;
const entity = (name) => ({
  get: async () => JOB,
