...
const WINDOW_QUOTES_ONLY_EMAILS = new Set(["faxonco@yahoo.com"]);
export const isWindowQuotesOnly = user => WINDOW_QUOTES_ONLY_EMAILS.has(String(user?.email || "").trim().toLowerCase());
