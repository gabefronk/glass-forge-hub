...
import { ArrowUpRight, BriefcaseBusiness, CheckCircle2, FileText } from "lucide-react";
...
export default function WindowQuoteResults({ quote, onWon, onPricingSave, busy }) {
