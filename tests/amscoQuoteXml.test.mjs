...
test("XML rejects wrong number, wrong application, bad prices, duplicates and incomplete line index",()=>{
 for(const xml of [
   ...
   fixture().replace("<alllineitemmasters><lineitemmaster/>","<alllineitemmasters><lineitemmaster/><lineitemmaster/>")
