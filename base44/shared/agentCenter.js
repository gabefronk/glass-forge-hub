...
const ids=new Set(['manager_agent','sales_tracker_agent','calendar_coordinator','probuild_reporting','codex_development','mac_manager','external_claude_agents','construction_plan_quoting','probuild_ipad_capture']);
